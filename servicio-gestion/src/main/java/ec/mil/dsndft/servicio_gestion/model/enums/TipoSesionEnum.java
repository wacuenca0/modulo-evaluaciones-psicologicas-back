...
public enum TipoSesionEnum {
    ...
    FAMILIAR("Familiar"),
    PAREJA("Pareja"),
    REMOTA("Remota", "Virtual", "Telematica"),
    MIXTA("Mixta", "Combinada");

    private final String canonical;
    private final Set<String> tokens;

    TipoSesionEnum(String canonical, String... aliases) {
    ...
    public static Optional<TipoSesionEnum> from(String raw) {
    ...
    public static TipoSesionEnum normalizeOptional(String raw) {
