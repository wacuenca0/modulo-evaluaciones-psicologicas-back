...
public enum SexoEnum {
    HOMBRE("Hombre", new String[]{"H", "MASCULINO", "VARON"}),
    MUJER("Mujer", new String[]{"F", "FEMENINO"}),
    OTRO("Otro", new String[]{"X", "NO_BINARIO", "NB", "OTRO"});

    private final String canonical;
    private final Set<String> tokens;

    SexoEnum(String canonical, String[] aliases) {
    ...
    public static Optional<SexoEnum> from(String raw) {
    ...
    public static String normalizeRequired(String raw) {
        return from(raw)
            .map(SexoEnum::getCanonical)
            .orElseThrow(() -> new IllegalArgumentException("Valor de sexo no soportado: " + raw));
    }
