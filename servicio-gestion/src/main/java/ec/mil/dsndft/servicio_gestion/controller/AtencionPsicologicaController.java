...
public class AtencionPsicologicaController {
    ...
    public ResponseEntity<ec.mil.dsndft.servicio_gestion.model.dto.AtencionPsicologicaPageDTO> listarPorPsicologo(@PathVariable Long psicologoId,
        ...
        if (content == null) content = java.util.Collections.emptyList();
        ec.mil.dsndft.servicio_gestion.model.dto.AtencionPsicologicaPageDTO dto = new ec.mil.dsndft.servicio_gestion.model.dto.AtencionPsicologicaPageDTO(
            content,
            result.getNumber(),
            result.getSize(),
    ...
    public ResponseEntity<ec.mil.dsndft.servicio_gestion.model.dto.AtencionPsicologicaPageDTO> listarPorPaciente(@PathVariable Long pacienteId,
                                               @RequestParam(defaultValue = "0") int page,
                                               @RequestParam(defaultValue = "10") int size) {
        org.springframework.data.domain.Pageable pageable = org.springframework.data.domain.PageRequest.of(page, size);
    ...
    public ResponseEntity<ec.mil.dsndft.servicio_gestion.model.dto.AtencionPsicologicaPageDTO> listarPorFiltroAtencion(
